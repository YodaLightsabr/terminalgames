...
Once in the terminal folder
run cligames(as one word) followed by Help
than you can run cligames list to view the current gamesDir

```to run  to bring up game menu)
(same applies for the game list)

## `>_` Current Commands
- `cligames help` - shows the Help menu
- `games Play` - Play a game(type in games play and the name of the game)
- `cligames list` - shows the current list of games
