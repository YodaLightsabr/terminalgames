...
console.log(chalk.blue('Terminal Games\n') + chalk.blueBright('entertaining  minigames to play in your terminal\n'));
...
const games = async () => {
  ...
  for (const commandFile of commandFilePaths) {
    ...
    commands[commandData.command] = {
      ...
      description: commandData.description || 'No enough info provided',
  ...
  if (command == undefined) {
    console.log('Run ' + formatting.command('Help') + ' to display all commands.');
